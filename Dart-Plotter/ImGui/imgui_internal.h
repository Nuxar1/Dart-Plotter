...
namespace ImGui
{
    ...
    IMGUI_API bool          CloseButton(ImGuiID id, const ImVec2& pos, const ImU32& bg_col = 0);
    IMGUI_API bool          MaximizeButton(ImGuiID id, const ImVec2& pos);
    ...
    // Plot
    IMGUI_API int           PlotEx(ImGuiPlotType plot_type, const char* label, float (*values_getter)(void* data, int idx), void* data, int values_count, int values_offset, const char* overlay_text, float scale_min, float scale_max, ImVec2 frame_size, float stride = 1);
